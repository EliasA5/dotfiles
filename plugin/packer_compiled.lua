...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/playground",
  ...
  undotree = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/undotree",
